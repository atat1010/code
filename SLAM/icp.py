"""
实现ICP算法，用于在3D点云或深度图之间进行配准。该算法通过迭代优化来最小化点到平面的距离，从而估计相机的位姿变化。
用于估计两个点云之间的刚体变换
"""
...
# 在Hessian矩阵中添加阻尼项（damping），防止优化过程中数值不稳定
...
def exp_se3(xi):
    """
    :param x: Cartesian vector of Lie Algebra se(3) 李代数向量
    :return: exponential map of x                   刚体变换矩阵
    """
